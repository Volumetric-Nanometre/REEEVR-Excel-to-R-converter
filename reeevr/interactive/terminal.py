...
testOutput =[('Summary results', 'F6:G9')]#[('Summary results', 'D6:E9')]  #[('Results', 'F13:H13'), ('Results', 'F12:H12')]   #
costs =[('Summary results', 'F6'),('Summary results', 'F7'),('Summary results', 'F8'),('Summary results', 'F9')]#[('Summary results', 'D6'),('Summary results', 'D7'),('Summary results', 'D8'),('Summary results', 'D9')] #[('Engine', 'E5'), ('Engine', 'F5')] #[('Results', 'F12'), ('Results', 'F13')]
effs = [('Summary results', 'G6'),('Summary results', 'G7'),('Summary results', 'G8'),('Summary results', 'G9')]#[('Summary results', 'E6'),('Summary results', 'E7'),('Summary results', 'E8'),('Summary results', 'E9')]#[('Engine', 'E6'), ('Engine', 'F6')]#[('Results', 'G12'), ('Results', 'G13')]
treatmentNames =['Cemented','Uncemented','Hybrid', 'Reverse Hybrid']#['Genedrive','Genomadix cube','Laboratory genetic test', 'No test']# #['Aspirin', 'Warfarin'] #['Drug A', 'Drug B']
willingnessToPay =[('Setup and run','D14')]#[('Setup and run','D20')]# #[('Model settings','N13')]
